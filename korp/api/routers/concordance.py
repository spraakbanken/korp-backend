...
@router.get(
    "/concordance/sample",
    response_model=None,
    responses=handler.docs_response(ConcordanceSampleResponse, corpus_authorization=True, cqp_error=True),
...
@router.get(
    "/concordance",
    response_model=None,
    responses=handler.docs_response(ConcordanceResponse, corpus_authorization=True, cqp_error=True),
    summary="Concordance",
